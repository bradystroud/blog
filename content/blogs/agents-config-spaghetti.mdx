...
I had skills in one place, other skills in another place, instructions duplicated across tools, and just enough drift that I could never be fully sure which version was the real one, and whicha agents had which config.
