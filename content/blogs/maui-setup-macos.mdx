...
description: Complete .NET MAUI setup guide for macOS. Install workload, Xcode, and Android Studio to build cross-platform apps for iOS, Android, and Mac with one codebase.
...
Getting started with .NET MAUI on macOS is straightforward once you know the tooling you need. With a single installation you can build and debug on iOS, Android, macOS.
