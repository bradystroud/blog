...
The script is available on GitHub. Save it as `~/.config/raycast/scripts/copilot-month-%-check.sh`.

If you want to share/fork it, it's in this repo: https://github.com/bradystroud/raycast-scripts/blob/main/copilot-month-%25-check.sh
