canonicalUrl: "https://bradystroud.dev/blogs/aspire-windows-vm-using-mac-docker"
...
> This article is the origin story & reasoning. For the current, hardened process (SSH hardening, clean shells, port strategy, diagnostics) skip straight to **[Part 2: Hardening & Port Strategy](./aspire-windows-vm-using-mac-docker-part-2)**.
...
Let me know if you want an automated setup script for provisioning the context and validating connectivity.

---

### Continue to Part 2

Next: **[Running .NET Aspire from a Windows VM Using macOS Docker – Part 2: Hardening & Port Strategy](./aspire-windows-vm-using-mac-docker-part-2)** for passwordless SSH setup, clean non-interactive shells, tunneling vs publishing ports, diagnostics toolbox, and troubleshooting patterns.
