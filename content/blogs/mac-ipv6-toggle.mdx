...
title: When Your VPN Hates IPv6: A Quick macOS Menu Bar Fix
description: I built a small Swift menu bar application that lets you quickly turn IPv6 on or off for Wi-Fi. It's a lifesaver if you deal with VPNs that hate IPv6.
