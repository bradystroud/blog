...
AI is brilliant at code-level reasoning, but sometimes its painful to provice enough context of a bug to get a useful output.
...
>  1. Add logs in that area - log to a local file
