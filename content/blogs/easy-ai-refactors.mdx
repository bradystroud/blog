...
description: Learn how to turn week-long refactors into 20-minute tasks using 15 AI agents working in parallel. A practical guide to distributed AI orchestration for large-scale code changes.
...
- 🔴 src/WebApi/Features/Billing/Endpoints/VoidInvoiceEndpoint.cs (Remove try-catch)
```
